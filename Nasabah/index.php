...
include "../koneksi.php";
$sql = mysqli_query($con, "Select * from tbl_user where username = '$_SESSION[namanas]'");
...
>
  <head>
    ...
    <title>Koperasi Rakyat Sejahtera</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo fw-bolder ms-2">Koperasi</span>
            </a>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item lh-1 me-3">
                  <a
                    ...
                    >Welcome. <?php echo"$ru[status] - $ru[nm_user]" ?></a
                  >
                </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block"><?php echo"$ru[nm_user]" ?></span>
                            <small class="text-muted"><?php echo"$ru[status]" ?></small>
                          </div>
                        </div>
                      </a>
                    </li>
...
<?php
  if(isset($_GET['page'])){
    ...
    switch ($page){
      ...
      break;
      case 'data_pengajuan_tambah':
      include"data_pengajuan_tambah.php";
      break;
      case 'data_pengajuan_edit':
      include"data_pengajuan_edit.php";
      break;
      case 'data_pengajuan_delete':
      include"data_pengajuan_delete.php";
      break;
      case 'data_kredit':
      include"data_kredit.php";
      break;
      case 'pembayaran':
