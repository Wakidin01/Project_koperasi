            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">KOPERASI UCIC</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Koperasi UCIC! 👋</h4>
...
<?php
  ...
  if($ru['status']=="Nasabah"){ 
  session_start(); 
  $_SESSION['namanas'] = $ru['username'];
  $_SESSION['passnas'] = $ru['password'];

  echo"<script language = 'JavaScript'>
  confirm('Login Sebagai Nasabah Berhasil!');
  document.location='Nasabah';
  </script>";
  }

  else if($ru['status']=="Administrator"){ 
  session_start(); 
  $_SESSION['namaadm'] = $ru['username'];
  $_SESSION['passadm'] = $ru['password'];

  echo"<script language = 'JavaScript'>
  confirm('Login Sebagai Administrator Berhasil!');
  document.location='Administrator';
  </script>";
  }

  else if($ru['status']=="Manager"){ 
  session_start(); 
  $_SESSION['namamg'] = $ru['username'];
  $_SESSION['passmg'] = $ru['password'];

  echo"<script language = 'JavaScript'>
  confirm('Login Sebagai Manager Berhasil!');
