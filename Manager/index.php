...
include"../koneksi.php";
$sqlu = mysqli_query($con, "Select * from tbl_user where username = '$_SESSION[namamg]'");
...
<?php
  if(isset($_GET['page'])){
    ...
    switch ($page){
      ...
      break;
      case 'data_pengajuan_proses':
      include"data_pengajuan_proses.php";
      break;
      case 'data_kredit':
