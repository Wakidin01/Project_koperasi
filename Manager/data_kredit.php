                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <?php
                        include"../koneksi.php";
                        $no=1;
                        $sqlp = mysqli_query($con,"select tbl_kredit.*, tbl_pengajuan.* from tbl_kredit JOIN tbl_pengajuan ON tbl_pengajuan.id_pengajuan = tbl_kredit.id_pengajuan ");
                      ...
                      <tr>
                        ...
                        <a href="<?php echo"index.php?page=data_pengajuan_proses&&idp=$rp[id_pengajuan]"; ?>" class="btn btn-success">Detail Pembayaran</a>
