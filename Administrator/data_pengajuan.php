                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <?php
                        include"../koneksi.php";
                        $no=1;
                        $sqlp = mysqli_query($con,"select * from tbl_pengajuan where status ='Proses Pengajuan' ");
                      ...
                      <tr>
                        ...
                        <a href="<?php echo"index.php?page=data_pengajuan_proses&&idp=$rp[id_pengajuan]"; ?>" class="btn btn-success">Proses Administrasi</a>
