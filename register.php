...
>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Buat User Account anda dibagian bawah ini</p>

  <form class="mb-3" method="POST">
  <div class="mb-3">
  <label class="form-label">Nama Lengkap</label>
    <input type="text" class="form-control" name="nm_user" placeholder="Enter your name"/>
  </div>  
  ...
  <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
   ...
   <div class="mb-3">
       <input class="btn btn-primary d-grid w-100" type="submit" value="Register">
   </div>
   </form>
...
<?php
    ...
    $query = mysqli_query($con,"insert into tbl_user(username, password, nm_user, status) value('$_POST[username]','$_POST[password]','$_POST[nm_user]','Nasabah')");  
